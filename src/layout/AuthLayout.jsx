            ...
            <div className="relative pt-0  px-4 sm:px-6 lg:px-8">
              <nav className="  relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
                ...
                <div className="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                  ...
                  <Link to="contacto" className="font-medium text-[#426db3] hover:text-gray-500">
                    ¡Dime Hola!
                  </Link>
                </div>
              </nav>
            ...
            >
              ...
              >
                <div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                  ...
                  <a
                    href="#"
                    className="block w-full px-5 py-3 text-center font-medium text-[#426db3] bg-gray-50 hover:bg-gray-100"
                  >
                    Iniciar sesión
                  </a>
                </div>
